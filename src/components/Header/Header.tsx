                    ...
                    <div className="header__menu">
                        <div className="header__menu__left">
                            <button className="header__button__userProfile">
                                <img src="./src/assets/user.svg" alt="Perfil do usuário" />
                            </button>
                            ...
                            <button className="header__button__wishes">
                                <img src="./src/assets/wishes.svg" alt="Lista de desejos" />
                            </button>
                        </div>
                        <div className="header__menu__right">
                            <button className="header__button__login">
                                Entrar
                                <img className="header__button__signIn" src="./src/assets/signIn.svg" alt="Entrar" />
                            </button>
                        </div>
                    </div>
                    ):(
